...
class TextVAE(nn.Module):
    ...
    @staticmethod
    def gpt_mlp(hidden_states, bias):
    ...
    def gpt_forward(input_ids, mask, bias):
        hidden_states = TextVAE.gpt(input_ids, attention_mask = mask, output_hidden_states = True).hidden_states[-2]
        ...
        hidden_states = TextVAE.gpt_mlp(hidden_states, bias)
    ...
    def forward(self, gpt_ids = None, gpt_mask = None, do_sample = True):
        ...
        bias, kl_loss = self.get_bias(gpt_ids, gpt_mask)
